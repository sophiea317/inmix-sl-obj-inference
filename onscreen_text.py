...
PRACTICE_SUCCESS_TEXT = (
    ...
    "{summary}\n\n"
    "You're ready for the main exposure phase.\n\n"
...
MAIN_EXPOSURE_START_TEXT = (
    "Great! Now the main exposure phase will begin.\n\n"
    "Press '{bigger_key}' if bigger than previous object\n"
    "Press '{smaller_key}' if smaller than previous object\n\n"
...
PRACTICE_TEST_COMPLETE_RETRY_TEXT = (
    "Practice Complete!\n\n"
    "You can choose to RESTART the practice if you feel you need more practice,\n"
    "or CONTINUE to the experiment if you understand the test format.\n\n"
...
PRACTICE_TEST_CONTINUE_TEXT = (
    ...
    "The real test will use images of real-world objects that you saw during the bigger/smaller task.\n\n"
...
MAIN_TEST_PHASE_TEXT = (
    ...
    "Press '{seq1_key}' for FIRST sequence\n"
    "Press '{seq2_key}' for SECOND sequence\n\n"
    "Press any key to begin the main test."
)
